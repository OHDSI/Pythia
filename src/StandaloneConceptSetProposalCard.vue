...
<template>
  ...
  >
    <div class="card-header">
      <span class="badge">New concept set</span>
...
.badge { display: inline-block; padding: 1px 6px; border-radius: 999px; background: #ecfccb; color: #3f6212; font-size: 0.6875rem; text-transform: uppercase; letter-spacing: 0.04em; }
